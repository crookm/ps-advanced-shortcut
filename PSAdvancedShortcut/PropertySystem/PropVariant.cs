...
namespace PSAdvancedShortcut.PropertySystem
{
    ...
    public sealed class PropVariant : IDisposable
    {
            ...
            lock (_padlock)
            {
                ...
                if (!_cache.TryGetValue(type, out action))
                {
                    ...
                    { // if the method was not found, throw.
                        throw new ArgumentException("The value type is not supported.");
                    }
        ...
        public PropVariant(string value)
        {
            if (value == null)
            {
                throw new ArgumentException("String argument cannot be null or empty", nameof(value));
            }
        ...
        private static Array CrackSingleDimSafeArray(IntPtr psa)
        {
            ...
            if (cDims != 1)
                throw new ArgumentException("Multi-dimensional SafeArrays not supported.", nameof(psa));
